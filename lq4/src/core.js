...
const ENEMIES = [
  ...
  {key:'nemurishika', name:'ねむり鹿',  hp:150,atk:34, def:26, agi:16, exp:620, gold:520, minLv:18,
   art:'yamiinu'},
  {key:'doronote',    name:'どろの手',  hp:170,atk:38, def:30, agi:10, exp:690, gold:580, minLv:18,
   art:'kagekakera', inflict:{type:'slow', p:0.16}},
  {key:'hainene',     name:'這い根',    hp:200,atk:41, def:34, agi:12, exp:830, gold:660, minLv:20,
   art:'kudamukade'},
  {key:'sennengoke',  name:'千年苔',    hp:230,atk:36, def:40, agi:8,  exp:900, gold:720, minLv:20,
   art:'nukegara'},
  {key:'kareedano',   name:'枯れ枝の 獣', hp:185,atk:44, def:28, agi:24, exp:790, gold:640, minLv:19,
   art:'kamigarasu'},
...
const byMap = {
  ...
  // ---- 第3章：地上 ----
  ground:    ['nemurishika','doronote','kareedano','hainene'],
  ice_cave:  ['nemurishika','doronote','kareedano','sennengoke','hainene'],
  well_cave: ['doronote','hainene','sennengoke','kareedano'],
};
