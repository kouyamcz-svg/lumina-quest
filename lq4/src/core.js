...
const MAPS = {
  ...
  ice_cave:{name:'氷窟', theme:'ice', enc:true, encRate:0.07, encGrace:6, tiles:[
    "#######################",
    "#######################",
    "###########D###########",
    "###########K###########",
  ...
  ice_core:{name:'氷の 奥', theme:'ice', enc:false, tiles:[
    ...
    "#########.#########"],
    warpsXY:{
      '9,11':{to:'ice_cave', x:11, y:4, back:true}
    }},
  ...
  // ★山道：ゼノスの 庵へ つづく 岩の 道
  peak_path:{name:'山道', theme:'cave', enc:true, encRate:0.08, encGrace:5, tiles:[
    "######################",
    "######################",
    "######################",
    "######..........######",
    ...
    "##########.###########"],
    warpsXY:{
      '10,20':{to:'ground', x:81, y:31, back:true}
    }},
