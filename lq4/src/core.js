...
const MAPS = {
  ...
  ground:{name:'地上', theme:'world', enc:true, encRate:0.06, encGrace:6, tiles:[
    ...
    warpsXY:{
      ...
      '80,32':{to:'peak_village', x:10, y:13},
      '48,30':{to:'toros', x:11, y:13},
      '53,31':{to:'shrine_hill', x:10, y:10},
      '79,29':{to:'zenos_cave', x:7, y:7},
      '81,30':{to:'peak_path', x:9, y:31},
  ...
  peak_path:{name:'山道', theme:'cave', enc:true, encRate:0.045, encGrace:6, tiles:[
    ...
    "#########.###########"],
    warpsXY:{
      '9,32':{to:'ground', x:81, y:31, back:true},
  ...
  zenos_cave:{name:'山肌の洞', theme:'cave', enc:false, tiles:[
    ...
    "#######.#######"],
    warpsXY:{
      '7,8':{to:'ground', x:79, y:30, back:true}
    }},
