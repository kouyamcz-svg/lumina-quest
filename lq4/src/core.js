...
const MAPS = {
  ...
  // ============ 第3章：湧き水の町（後の ザール）============
  // ★東の 砂漠の 町（LQ3 の ザール／オアシスの サーラの 側）
  well_town:{name:'湧き水の町', theme:'desert', enc:false, tiles:[
    "#########################",
    "#.......................#",
    "#..H..H....###....H..H..#",
    "#..I..S....#w#....H..P..#",
    ...
    "############G############"],
    warpsXY:{
      '12,14':{to:'ground', x:80, y:33},
      '12,7' :{to:'well_cave', x:11, y:27}
    }},
  ...
  well_cave:{name:'地下水路', theme:'cave', enc:true, encRate:0.045, encGrace:6, tiles:[
    ...
    "###########.###########"],
    warpsXY:{
      '11,28':{to:'well_town', x:12, y:7, back:true},
...
const WARDS = {
  ...
  well_town: {chapter:4, flag:'ch3_iceDone',
    earlyInChapter:['湧き水の町。井戸の まわりに 人が 集まって いる。',
              '町の 者「空の 者か。……今年は まだ 荷が 来とらんが」',
              'セレン「順に 回って います。まだ 北の 谷の ぶんが」',
              'イオ「……先に 氷の谷を 片づけましょう」'],
    msg:['湧き水の町。東と 西で にらみあって いる。']},
