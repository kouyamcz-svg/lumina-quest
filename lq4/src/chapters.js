...
const CH = {
  ...
  1: {
    ...
    bossReward: {
      ...
      umbra: {
        set:['ch0_umbraDown'],
        quest:{ch0_q2_umbra:'clear'},
        setState:'NORMAL',
        msg:['', 'ウンブラは ほどけ、黒い 紙片に なって 散った。',
             'ノエ「……これ、夢の 切れはしだ」',
             '（下層区の 子どもが ひとり、紙片を 見つめている）',
             '', '＊ 住民は 無事だった ＊'],
      },
    },
    ...
    // --- 章の おわり ---
    ending: {
      trigger: 'ch0_umbraDown',
      set:['ch0_cleared'],
      msg:['グラン「配属前の 身で 前へ 出たな」',
           'イオ「……人が いたので」',
           'グラン「それでいい。守る 順番を 間違えなかった」',
           'グラン「イオ。今日から 天空騎士団 所属だ」',
           'セレン「……ずるい。首席は わたしなのに」',
           '',
           '空の 裂け目は 閉じた。だが 誰も、なぜ 開いたかを 知らない。'],
