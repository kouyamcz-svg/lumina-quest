...
const MAP_IDS = {
  ...
  sky_port:   {region:'sky', kind:'town', name:'雲海港',      scene:'SCENE_SKY_TOWN'},
  // ---- 第3章：地上 ----
  ...
  well_core:  {region:'land',kind:'dgn',  name:'水脈の 奥',   scene:'SCENE_CAVE'},
  sea_core:   {region:'land',kind:'dgn',  name:'潮だまりの 奥',scene:'SCENE_CAVE'},
  peak_core:  {region:'land',kind:'dgn',  name:'山頂',        scene:'SCENE_CAVE'},
  zenos_cave: {region:'land',kind:'dgn',  name:'山肌の洞',   scene:'SCENE_CAVE'},
  well_town:  {region:'land',kind:'town', name:'湧き水 東の集落',  scene:'SCENE_FIELD'},
  well_west:  {region:'land',kind:'town', name:'湧き水 西の集落',  scene:'SCENE_FIELD'},
  ...
  tower4:     {region:'sky', kind:'dgn',  name:'雲見の 塔 四階',   scene:'SCENE_SKY_TOWN'},
  tower5:     {region:'sky', kind:'dgn',  name:'雲見の 塔 最上階', scene:'SCENE_SKY_TOWN'},
