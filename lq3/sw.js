...
self.addEventListener('fetch',e=>{
  ...
  if(url.pathname.endsWith('/assets.js') || url.pathname.endsWith('/field.mp3') || url.pathname.endsWith('/castle.mp3') || url.pathname.endsWith('/town.mp3') || url.pathname.endsWith('/battle3.mp3') || url.pathname.endsWith('/dungeon.mp3')){
