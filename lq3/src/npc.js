...
const NPCS = {
  ...
  elde_town: [
    ...
    {at:'17,9', spr:'butler', name:'うわさずきの けんじゃ', lines:[
      ...
      {when:{flag:'ch4_started'}, text:[
        '「＜ものまねし＞の たびの ものが さんどうを のぼって いった」',
  ...
  minamo_port: [
    ...
    {at:'18,10', spr:'villagerB', name:'うわさずきの ふなのり', lines:[
      ...
      {when:{flag:'ch3_gotShell'}, text:[
        '「ほらあなから もどってきた ＜ものまねし＞に あったぜ」',
        '「＜かいは よく きいてくれた。',
        'にんげんより ずっと＞だとよ」',
        '「まものと たたかいに いったんじゃ ないのか あいつ」']},
      {when:{flag:'ch3_sawDream'}, text:[
        '「＜ものまねし＞なら かいしょくどうの ほうへ こぶねを かりていった」',
        '「＜あそこは よく ひびく＞って いってな」',
        '「まものしか いないぞ、と おしえたんだが きかなかった」']},
      {text:['「さんばしで うたってた やつが いてな。みんな ＜ものまねし＞って よんでる」',
    ...
    {at:'7,9', spr:'elderWoman', name:'うらないの ししょう', lines:[
      ...
      {when:{flag:'ch3_started'}, text:[
        ...
        '「ルカ、セナを たのんだよ」']},
      {when:{ch:5, flag:'ch5_south'}, text:[
        'ししょう「ふたごを たのむぞ、ひかりのこ」',
        '「うみの おくの かけら、ゆだんは ならん」']},
      {when:{ch:5}, text:[
        'ししょう「……ほう。ゆめの けはいを まとった こじゃ」',
        '「おまえが うわさの ひかりのこ かえ」']},
  ...
  zaal_town: [
    ...
    {at:'7,8', spr:'butler', name:'しょうかいちょう', lines:[
      ...
      {when:{ch:5, flag:'ch5_east'}, text:[
        'しょうかいちょう「ひがしは たのんだぞ。しょうにんは まちに つよい」']},
      {when:{ch:5}, text:[
        'しょうかいちょう「トロスの つかいか。よく きた」',
        '「この まちも ねむる ものが ふえて こまって おる」']},
  ...
  versa_town: [
    ...
    {at:'20,11', spr:'villagerB', name:'うわさずきの おとこ', lines:[
      ...
      {when:{state:'SLEEPING_SICKNESS'}, text:[
        '「＜ものまねし＞と よばれる たびの ものを みなかったか」',
        '「ねむりびょうが はじまる すこし まえに、まちを あるいていたそうだ」']},
      {text:['「＜ものまねし＞の うわさ、きいた ことは ないか」',
             '「きたの みちで すれちがったんだ。かおは みえなかったが」']}]},
    {at:'13,6', spr:'guardA', name:'もんばん', lines:[
      {when:{ch:5}, text:[
        '「よそから きたのか。この まちも ねむりびょうでな」',
        '「きしだんの わかいのが、けさも 2り たおれた」']},
      {when:{state:'DREAM_INVASION'}, text:[
    ...
    {at:'8,9', spr:'captain', name:'きしだんちょう', lines:[
      {when:{ch:5, flag:'ch5_north'}, text:[
        '「きたの こおりの おくは かたづけたか。たのんだぞ」']},
      {when:{ch:5}, text:[
        '「トロスの こぞうか。……いい めを している」',
        '「ねむりびょうの もとを さがして いるなら はなしを きけ」']},
  ...
  versa_town2: [
    ...
    {at:'12,6', spr:'elderWoman', name:'ものしりの おんな', lines:[
      ...
      {when:{flag:'ch1_heardTheft'}, text:[
        '「＜ものまねし＞なら どうくつの ほうへ あるいていったわ」',
        '「とめたのよ。まものが でるって」',
        '「そうしたら＜きゃくが いないから、まものに きかせる＞ですって」']},
      {text:['「＜ものまねし＞なら みたわ。ゆきの なかで うたっていたの」',
  ...
  versa_hut: [
    {at:'5,2', spr:'elderWoman', name:'くすし', lines:[
      ...
      {when:{ch:5}, text:['くすし「おや、たびの こかい。とおい ところを」',
        '「ねむりびょうの ねっこは、くすりでは たてないよ」']},
  ...
  versa_cast1: [
    {at:'10,2', spr:'king', name:'おう', lines:[
      ...
      {when:{ch:5, flag:'ch5_shard1'}, text:[
             'おう「むすめが めを さました！」',
             '「そなたらは くにの おんじんじゃ。れいを いう」',
             '「のこる かけらも、どうか たのむぞ」']},
      {when:{ch:5}, text:['おう「ひかりのこ とやら、うわさは きいて おる」',
             '「むすめの ねむり……もとを たってくれ。たのむ」']},
      {text:['おう「むすめが めを さまさぬ。いしゃも てだてが ないという」',
             '「たのむ、リオン。おまえだけが たよりだ」']},
    ]},
    {at:'8,7', spr:'butler', name:'じい', lines:[
      {when:{ch:5, flag:'ch5_shard1'}, text:[
        'じい「おうじょさまが おめざめに なった！」',
        '「ながい ねむりじゃった。……こころから かんしゃ するぞ」']},
      {when:{ch:5}, text:[
        'じい「おうじょさまは おくの ねまじゃ」',
        '「めざめぬ ねむりが、また はじまって しもうた」']},
      {when:{flag:'ch1_cleared'}, text:[
