...
const MIDBOSS = {
  ...
  dreameater_a:{key:'dreameater_a', name:'まおう デスグラン', hp:1460, atk:51, def:28, agi:20, acts:2,
    exp:2400, gold:1000, art:'desgran1',
  ...
  dreameater_b:{key:'dreameater_b', name:'デスグラン・しんのすがた', hp:1690, atk:58, def:30, agi:22, acts:2,
    ...
    charge:{p:0.18, mul:2.0, tell:'あくむが ひとつに あつまって いく…', name:'おわりの ひとつき'},
    brace:{p:0.15, name:'ゆめの まくに つつまれた！'},
    enrage:{at:0.35, atk:1.10, chargeP:0.26, name:'あくむが かたちを かえた！'}},
