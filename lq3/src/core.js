...
const MIDBOSS = {
  ...
  dreameater_a:{key:'dreameater_a', name:'まおう ムゲンロス', hp:1460, atk:51, def:28, agi:20, acts:2,
    ...
    enrage:{at:0.40, atk:1.10, name:'ムゲンロスが みぶるいした！'}},
  dreameater_b:{key:'dreameater_b', name:'ムゲンロス・しんのすがた', hp:1690, atk:58, def:30, agi:22, acts:2,
