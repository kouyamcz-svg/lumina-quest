...
const SPELL_DEFS = {
  ...
  // ---- ゆうしゃ せんよう（ソラ） ----
  prayer: {name:'ルミナの いのり', mp:30, type:'healall', min:110, max:150},
  genesis:{name:'はじまりの ひかり', mp:40, type:'dmgall', min:120, max:160},
...
const CLASSES = {
  sora:  {name:'ソラ',  hp:16,mp:5,atk:5,def:3,agi:6, g:{hp:5,mp:3,atk:2,def:2,agi:1},
          learns:[{lv:2,key:'spark'},{lv:3,key:'heal'},{lv:6,key:'blaze'},{lv:9,key:'nova'},
                  {lv:11,key:'hiheal'},{lv:14,key:'bolt'},{lv:21,key:'holyray'},
                  {lv:26,key:'fullheal'},{lv:30,key:'luminaflare'},{lv:35,key:'prayer'},
                  {lv:40,key:'judgment'},{lv:46,key:'genesis'}]},
...
const MIDBOSS = {
  ...
  nushicrab:{key:'nushicrab', name:'ぬしヤドガニ', hp:180, atk:18, def:23, agi:7, acts:1,
    ...
    brace:{p:0.24, name:'からに こもった！'}},
  // 第5章 ボス「ゆめの ぬし」：むらを のみこんだ きりの ぬし。
  // 第5章めぐり「よっつの かけら」：かくちの あくむの すがたを うつした かげ
  shardhound:{key:'shardhound', name:'よみがえりし ゆめのばんけん', hp:560, atk:40, def:19, agi:16, acts:1,
    exp:800, gold:420, art:'rev_banken',
    skill:{p:0.31, mul:1.32, name:'ゆめを かみくだく'},
    aoe:{p:0.21, lo:15, hi:21, name:'しろき とおぼえ'},
    inflict:{type:'sleep', p:0.23},
    charge:{p:0.18, mul:2.0, tell:'きばに ちからを ためて いる…', name:'だんがいの きば'},
    enrage:{at:0.35, atk:1.10, chargeP:0.26, name:'ゆめの きばを むきだした！'}},
  shardgolem:{key:'shardgolem', name:'よみがえりし ねむりぬし', hp:960, atk:51, def:25, agi:12, acts:1,
    exp:1000, gold:520, art:'rev_golem',
    skill:{p:0.35, mul:1.45, name:'すなの てっつい'},
    aoe:{p:0.24, lo:22, hi:29, name:'ねむりの すなあらし'},
    inflict:{type:'sleep', p:0.24},
    charge:{p:0.16, mul:1.2, aoe:true, tell:'じめんが ゆれはじめた…', name:'だいちの じんどう'},
    brace:{p:0.18, name:'いわはだを かたく とじた！'}},
  shardsis:{key:'shardsis', name:'よみがえりし あねのかげ', hp:680, atk:50, def:24, agi:20, acts:1,
    exp:700, gold:330, art:'rev_sisA',
    skill:{p:0.29, mul:1.28, name:'ゆめうつしの まい'},
    inflict:{type:'confuse', p:0.19},
    charge:{p:0.15, mul:2.0, tell:'ゆめの ちからを あつめて いる…', name:'ゆめおとしの まい'},
    enrage:{at:0.35, atk:1.10, name:'いもうとの なを さけんだ！'}},
  shardsis_b:{key:'shardsis_b', name:'よみがえりし いもうとのかげ', hp:640, atk:48, def:22, agi:24, acts:1,
    exp:550, gold:270, art:'rev_sisB',
    aoe:{p:0.3, lo:22, hi:30, name:'しおの さかまき'},
    inflict:{type:'sleep', p:0.16},
    brace:{p:0.20, name:'みずの まくを はった！'}},
  shardeater:{key:'shardeater', name:'よみがえりし こうかいのかげ', hp:1080, atk:46, def:25, agi:18, acts:2,
    exp:1600, gold:750, art:'rev_shadow',
    skill:{p:0.31, mul:1.32, name:'ゆめを すする'},
    aoe:{p:0.23, lo:21, hi:29, name:'くろい こだま'},
    inflict:{type:'sleep', p:0.21}, drain:0.16,
    charge:{p:0.15, mul:2.0, tell:'こうかいが ふくれあがって いる…', name:'とりかえせぬ いちげき'},
    enrage:{at:0.35, atk:1.10, name:'こうかいが あふれだした！'}},
  ...
  dreameater_a:{key:'dreameater_a', name:'まおう デスグラン', hp:1150, atk:51, def:28, agi:20, acts:2, scale:1.35,
    exp:1200, gold:500, art:'desgran1',
    skill:{p:0.32, mul:1.36, name:'ゆめを くらう'},
    aoe:{p:0.24, lo:25, hi:34, name:'あんこくの なみ'},
    inflict:{type:'sleep', p:0.22}, drain:0.15,
    charge:{p:0.16, mul:1.2, aoe:true, tell:'あたりの ゆめを すいこんで いる…', name:'ゆめのみの あぎと'},
    enrage:{at:0.40, atk:1.10, name:'デスグランが みぶるいした！'}},
  dreameater_b:{key:'dreameater_b', name:'デスグラン・おんねんのすがた', hp:950, atk:45, def:26, agi:22, acts:2, scale:1.35,
    exp:1200, gold:500, art:'desgran2',
    aoe:{p:0.32, lo:26, hi:35, name:'おんねんの ほのお'},
    inflict:{type:'confuse', p:0.22}, drain:0.15,
    charge:{p:0.16, mul:1.2, aoe:true, tell:'おんねんが うずを まいて いる…', name:'ごくえんの うねり'}},
  dreameater_c:{key:'dreameater_c', name:'デスグラン・しんのすがた', hp:1580, atk:58, def:30, agi:22, acts:2, scale:1.5,
    exp:3200, gold:1400, art:'desgran3',
    skill:{p:0.34, mul:1.4, name:'むすうの しょくしゅ'},
    aoe:{p:0.27, lo:30, hi:40, name:'むの こだま'},
    inflict:{type:'sleep', p:0.20}, drain:0.2,
    charge:{p:0.18, mul:2.0, tell:'しょくしゅが ひとつに あつまって いく…', name:'おわりの ひとつき'},
    brace:{p:0.15, name:'やみの まくに つつまれた！'},
    enrage:{at:0.35, atk:1.10, chargeP:0.26, name:'まじんが ほんきを だした！'}},
  ...
  snowbeast:{key:'snowbeast', name:'ひとつめの あらくれ', hp:400, atk:37, def:18, agi:15, acts:1,
    ...
    charge:{p:0.18, mul:2.0, tell:'こんぼうを たかく ふりかぶった…', name:'たたきつぶし'}},
  ...
  regretshadow:{key:'regretshadow', name:'こうかいの かげ', hp:700, atk:58, def:20, agi:17, acts:1,
    ...
    charge:{p:0.18, mul:2.0, tell:'あの ひの こえが たかまって いく…', name:'もどらぬ いちげき'},
    enrage:{at:0.35, atk:1.10, name:'こうかいが かたちを うしなった！'}},
  ...
  dreamwarlock:{key:'dreamwarlock', name:'まどろみの しもべ', hp:280, atk:30, def:12, agi:18, acts:1,
    ...
    brace:{p:0.22, name:'つえで まもりを かためた！'}},
  ...
  shadowsis_a:{key:'shadowsis_a', name:'あねの かげ', hp:275, atk:33, def:16, agi:16, acts:1,
    ...
    charge:{p:0.18, mul:2.0, tell:'つめに ゆめを ためて いる…', name:'ゆめさきの ひとかき'}},
  shadowsis_b:{key:'shadowsis_b', name:'いもうとの かげ', hp:240, atk:29, def:14, agi:20, acts:1,
    ...
    brace:{p:0.22, name:'あねの かげに よりそった！'}},
  ...
  desgran1:{key:'desgran1', name:'まおう デスグラン', hp:500, atk:43, def:28, agi:14, acts:2,
            ...
            charge:{p:0.18, mul:2.0, tell:'つえに やみを ためこんで いる…', name:'あんこくの いちげき'}},
  ...
  desgran3:{key:'desgran3', name:'デスグラン・まじんのすがた', hp:750, atk:51, def:30, agi:15, acts:2,
            ...
            charge:{p:0.18, mul:2.0, tell:'まじんが ちからを ためこんで いる…', name:'めっしんの いちげき'},
            brace:{p:0.14, name:'やみの よろいを まとった！'},
            enrage:{at:0.35, atk:1.10, chargeP:0.26, name:'デスグランが ほんきを だした！'}},
};
// ★マップごとの けいけんち ばいりつ。
...
const MAPS = {
  ...
  world:{name:'ヴェルサちほう',theme:'world',enc:true,encRate:0.05,encGrace:6,tiles:[
    ...
    "~~~~~~~~___~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^rrr___~~~~~~~~~~~~~~~",
    "~~~~~~__...__~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~_______~~~~~~.,^^^^^^^^^^^^::r::::___~~~~~~~~~~~~",
    "~~~___......._~~~~~~~~~~~~~~~~________~~~~_____......._~~~~~.,t,,^^^^^^^^^^:r:::::::___~~~~~~~~~",
    "~~_.......,..._~~~~~~~~~~~~~~~_,,...._~~~~___..........__~~~.,...^^^^^^^^^::r::::::::::______~~~",
    "~~_............_~~~~~~~~~~_~~~_.......__~~~~~_..,......._~~~^.^.,^^^^^^^^^^:r::::::::::::::::__~",
    "~~~_.....A......_~~~~~~~~~_~~~_.t....._~~~~~_..,.,......._~~,,,.^^^^^^^^^^::r::::::::::::^:::::_",
    "~~~~_.,........._~~~~~~~~~.^~~_.,...,.._~~~_t...A........._~t...,^^^^^^^::::r:::::^::::::::^::::",
    "~~~~~_.....^^^^^.____~~~~~.^^^......,._~~~~~_.............._,..^^^^^^^^^^:^:r:::::::::::::::::::",
    "~~~~_..,.^^^^^^^^^..._~~~~.^~^t...t..__~~~__.........,....._t,^^^^^^^^::::::rrrrA:::^:::::::::::",
    "~~~~_...^^^^^^^^^^^..._~~~.^^^_....._~~~~_.t........._______^^^^^^^^^:::::::::::r::^::::^:^:::::",
    "~~~_...^^^^^^^^^^^^^.._~~~.^^^~_..__~~~~_.t...,....._.^^^^^.^^^^^^^^:::::::::^::r:::.::::::::::_",
    "~~~~_..^^^^^^^^^^^^^.._~~~.^^^~~__~~~~~_.,.t.,....._.t.^^^^^^^^^^^^^::^^:^:rrrrrr::::::::::^::_~",
    "~~~~_.^^^^^^^^^^^^^^^.._~~.^^^~~~__~~~~~_,..t....._^.t^^^^^^^^^^^^^^^:::::^r^rrrr:::::::::::::_~",
    "~~~_...^^^^^^^^^^^^^...._~_^^^~~_._~~~~~_........_^^^..^^^^^.^^^^^^^^^^::::::::^r:::::::^:^::_~~",
    "~~_..,.^^^^^^^^^^^^^...._~~~~~~~~__~~~~~_...,....._^,.,^^^^,,^^^^^^^^^::::::::::r:::^::::::::_~~",
    "~~_.....^^^^^^^^^^^......_~~~~~__.t_~~~~~__........_^^^^^^^..^^^^^^^^^^::::::wwwr:::::::::::^_~~",
    "~~_.,.X.,^^^^^^^^^......._~~~~_.t..,__~~~~~_.....X.._^^^^.,....,.^^^^^^^^:::wwwwrrrrrrV:::^::_~~",
    "~~~_.......^^^^^........._~~~~_....,.,_~~~~~_........_______....^t^^^^^^^::::www:::::::::::::_~~",
    "~~~_....................._~~~~_...,...,_~~~~_......,......._..t....^^^^^^:X::ww::::::::::::::_~~",
    "~~~~_...................._~~~~_......._~~~~~_.......,......_..^..^^^^^^^^..::::^::::^::::::::_~~",
    "~~~~~_......,.......X...__~~~~_..t....._~~~~_.............._..^^.^^^^^^^^^.:::::::::::::::::_~~~",
    "~~~~~_,........,......__~~~~~~~_.,tt___~~~~~_...........__._.,..^^^^^^^^^^^:::::::::::______~~~~",
    "~~~~~~_.....___......_~~~~~~~~~~_.,_~~~~~~~_.......,..__~~__..t,^^^^^^^^:^::::::^::___~~~~~~~~~~",
  ...
  cave2:{name:'ゆめみの どうくつ B2',theme:'cave',enc:true,tiles:[
    ...
    "_____________#",
    "##############",
  ], warps:{}, warpsXY:{'0,9':{to:'cave1',x:12,y:10},'6,1':{to:'cave3',x:19,y:14}}},
  cave3:{name:'ゆめみの どうくつ B3',theme:'cave',enc:true,tiles:[
    "######################",
    "#C_____#______#_____C#",
    "#__##__#__B__>#__##__#",
    "#__##__#______#__##__#",
    "#______###__###______#",
    "#__#________________##",
    "#__#__www__#__#####__#",
    "#__#__www__#______#__#",
    "#__#___t___#__#___#__#",
    "#__#####___#__#_C_#__#",
    "#______#___#__#___#__#",
    "#__##__#___#__#####__#",
    "#__##______#_________#",
    "#______#___#_____#___#",
    "#___o__#___#__t__#_<_#",
    "######################",
  ], warps:{}, warpsXY:{'19,14':{to:'cave2',x:6,y:1},'13,2':{to:'cave2',x:1,y:9}}},
};
...
function interact(){
  ...
  if(ch==='Z'){                       // ねむる おうじょ
    G.mode='msg';
    const F=G.flags;
    // ★第1章いがいでは 1章の クエストは うごかさない（5章で 1章イベントが でる ふぐあいが あった）
    if((G.chapter||1)!==1){
      if((G.chapter||1)===5 && F.ch5_shard1){
        U.msg(['おうじょは めざめ、まどに むかって たって いた。',
               'おうじょ「こおりの こえが きえたわ」',
               '「……ありがとう。ひかりのこと、わたしの きし」'], ()=>{ G.mode='field'; });
      }else{
        const hasLion = party.some(p=>p.cls==='lion');
        U.msg(['ベッドに おうじょさまが ねむって いる。',
               'ねがえりも うたず、いきだけが しずかに つづく。']
          .concat(hasLion ? ['リオン「……かならず、もとを たちます」'] : []),
          ()=>{ G.mode='field'; });
      }
      return;
    }
