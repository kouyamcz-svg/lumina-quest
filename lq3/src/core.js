...
const MIDBOSS = {
  ...
  shardhound:{key:'shardhound', name:'かけらの ガーゴイル', hp:520, atk:38, def:19, agi:16, acts:1,
    exp:800, gold:420, art:'gargoyle',
    skill:{p:0.31, mul:1.32, name:'ゆめを かみくだく'},
    aoe:{p:0.21, lo:15, hi:21, name:'しろき とおぼえ'},
    inflict:{type:'sleep', p:0.23}},
  shardgolem:{key:'shardgolem', name:'かけらのぬし グラード', hp:900, atk:49, def:25, agi:12, acts:1,
    exp:1000, gold:520, art:'nushi',
    skill:{p:0.35, mul:1.45, name:'すなの てっつい'},
    aoe:{p:0.24, lo:22, hi:29, name:'ねむりの すなあらし'},
    inflict:{type:'sleep', p:0.24}},
  shardsis:{key:'shardsis', name:'かけらの こくりゅう', hp:940, atk:46, def:23, agi:20, acts:2,
    exp:1250, gold:600, art:'kokuryu',
    skill:{p:0.29, mul:1.28, name:'ゆめうつしの まい'},
    aoe:{p:0.22, lo:20, hi:27, name:'しおの さかまき'},
    inflict:{type:'confuse', p:0.19}},
  shardeater:{key:'shardeater', name:'ゆめくいの つかい ダルガ', hp:1080, atk:46, def:25, agi:18, acts:2,
    exp:1600, gold:750, art:'darga',
